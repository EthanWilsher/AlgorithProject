...
public class GameScene: SKScene, SKPhysicsContactDelegate
{
    ...
    func levelComplete() -> Void
    {
        if(gameLevel <= maxLevels)
        {
            ...
            let transitionType = SKTransition.flipHorizontal(withDuration: 6.6)
    ...
    func didBeginContact(contact: SKPhysicsContact) -> Void
    {
        ...
        if ((firstBody.categoryBitMask & CollisionCatgories.Invader != 0) &&
            (secondBody.categoryBitMask & CollisionCatories.PlayerLaser != 0))
        {
